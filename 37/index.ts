...
function make_shirt(size:string = "large", message:string = "I love Programming."){
    console.log(`Iam making a T-shirt with ${size} size and a text message ${message} will written on it.`);
};
make_shirt();
